...
export interface TApiKit<ResponseType> {
  ...
  configPerFetchResolver: (resolver: ApiKitConfigPerFetchResolver) => TApiKit<ResponseType>;
...
export type ApiKitConfigPerFetchResolver = (config: ApiKitConfigPerFetch) => ApiKitConfigPerFetch;
